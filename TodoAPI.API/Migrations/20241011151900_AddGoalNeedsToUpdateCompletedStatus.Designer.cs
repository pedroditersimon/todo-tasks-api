...
namespace TodoAPI.API.Migrations
{
    ...
    [Migration("20241011151900_AddGoalNeedsToUpdateCompletedStatus")]
    partial class AddGoalNeedsToUpdateCompletedStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TodoAPI.Data.Models.TodoGoal", b =>
                {
                    ...
                    b.Property<bool>("NeedsToUpdateCompletedStatus")
                        .HasColumnType("boolean");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            IsFavorite = false,
                            LastDeletedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LastUpdatedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Realizar Pedido a Proveedores",
                            NeedsToUpdateCompletedStatus = false
                        },
                        new
                        {
                            ID = 2,
